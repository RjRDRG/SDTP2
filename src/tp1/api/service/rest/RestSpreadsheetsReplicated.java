...
@Path(RestSpreadsheetsReplicated.PATH)
public interface RestSpreadsheetsReplicated {
	...
	String createSpreadsheet(@HeaderParam(RestSpreadsheetsReplicated.HEADER_VERSION) Long version, Spreadsheet sheet, @QueryParam("password") String password ) throws Exception;
	...
	@DELETE
	@Path("/{sheetId}")
	void deleteSpreadsheet(@HeaderParam(RestSpreadsheetsReplicated.HEADER_VERSION) Long version, @PathParam("sheetId") String sheetId, @QueryParam("password") String password) throws Exception;
	...
	@Path("/{sheetId}")
	@Produces(MediaType.APPLICATION_JSON)
	Spreadsheet getSpreadsheet(@HeaderParam(RestSpreadsheetsReplicated.HEADER_VERSION) Long version, @PathParam("sheetId") String sheetId , @QueryParam("userId") String userId,
	...
	@Path("/{sheetId}/values")
	@Produces(MediaType.APPLICATION_JSON)
	String[][] getSpreadsheetValues(@HeaderParam(RestSpreadsheetsReplicated.HEADER_VERSION) Long version, @PathParam("sheetId") String sheetId,
	...
	@Produces(MediaType.APPLICATION_JSON)
	String[][] getReferencedSpreadsheetValues(@HeaderParam(RestSpreadsheetsReplicated.HEADER_VERSION) Long version, @PathParam("sheetId") String sheetId , @QueryParam("userId") String userId, @QueryParam("range") String range) throws Exception;
	...
	@Path("/{sheetId}/{cell}")
	@Consumes(MediaType.APPLICATION_JSON)
	void updateCell(@HeaderParam(RestSpreadsheetsReplicated.HEADER_VERSION) Long version, @PathParam("sheetId") String sheetId, @PathParam("cell") String cell, String rawValue,
                    @QueryParam("userId") String userId, @QueryParam("password") String password) throws Exception;
	...
	void shareSpreadsheet(@HeaderParam(RestSpreadsheetsReplicated.HEADER_VERSION) Long version, @PathParam("sheetId") String sheetId, @PathParam("userId") String userId,
                          @QueryParam("password") String password) throws Exception;
	...
	@DELETE
	@Path("/{sheetId}/share/{userId}")
	void unshareSpreadsheet(@HeaderParam(RestSpreadsheetsReplicated.HEADER_VERSION) Long version, @PathParam("sheetId") String sheetId, @PathParam("userId") String userId,
                            @QueryParam("password") String password) throws Exception;
	...
	@DELETE
	@Path("/all/{userId}")
	void deleteUserSpreadsheets(@HeaderParam(RestSpreadsheetsReplicated.HEADER_VERSION) Long version, @PathParam("userId") String userId, @QueryParam("password") String password) throws Exception;
}
